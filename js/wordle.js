...
function markgreen (index) {
    console.log(index)
    document.getElementsByClassName("row")[6-guessesRemaining].children[index].style.backgroundColor = "green"
}

function markyellow (index) {
    console.log(index)
    document.getElementsByClassName("row")[6-guessesRemaining].children[index].style.backgroundColor = "yellow"
}
...
function resetGame() {
    ...
    for (const elem of document.getElementsByClassName("cell")) {
        ...
        elem.textContent = ""
        elem.classList.remove("filled-box")
    }
}